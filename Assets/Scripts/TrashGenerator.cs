...
public class TrashGenerator : MonoBehaviour
{
    ...
    private float gravMin = 25;
    private float gravMax = 30; 
    private float scaleMin = 4;
    private float scaleMax = 5;
    private float speedMin = 135;
    private float speedMax = 150;
    private string instantiatedTag = "InstantiatedObject";
    private GameObject randomTrash = null;
    
    public void Generate(int numberItems)
    {
        for (int i = 0; i < numberItems; i++)
        {
            ...
            Vector2 randomPosition = new Vector2(randomX, 450);
